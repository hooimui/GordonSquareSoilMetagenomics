...
With the merged BIOM-formated table 'merged_otu_table.biom' and phylogenetic tree '97_otus.tree', the downstream analysis is performed using the command in 'Data Analysis.txt'
